...
namespace RtEngine
{
    ...
    public:
        ...
        RendererStackFactory(std::shared_ptr<VulkanContext> vulkan_context, std::shared_ptr<PresentStage> present_stage,
            std::shared_ptr<MeshRepository> mesh_repository, std::shared_ptr<TextureRepository> texture_repository,
