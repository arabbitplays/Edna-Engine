...
namespace RtEngine
{
    ...
    public:
        ...
        CyclicalCellularAutomatonRenderer(const std::shared_ptr<VulkanContext>& vulkan_context, VkExtent2D image_extent,
        ...
        {
            push.update = update ? 1u : 0u;
        }
        void setUpdateChance(float chance)
        {
            push.update_chance = chance;
        }
        void setMutationChance(float chance)
        {
            push.mutation_chance = chance;
        }
