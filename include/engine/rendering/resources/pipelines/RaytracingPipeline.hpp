...
namespace RtEngine
{
    ...
    public:
        ...
        RaytracingPipeline(const std::shared_ptr<VulkanContext>& context) : context(context)
        {
            clear();
        }
        ...
        void addShaderStage(
            VkShaderModule shaderModule, VkShaderStageFlagBits shaderStage, VkRayTracingShaderGroupTypeKHR shaderGroup);
