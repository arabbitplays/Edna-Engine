...
namespace RtEngine
{
    ...
    public:
        MetalRoughMaterial(
            std::shared_ptr<VulkanContext> context, std::shared_ptr<TextureRepository> tex_repo, VkSampler sampler)
        ...
        void writeMaterial(
            AllocatedBuffer material_buffer, std::shared_ptr<MaterialTextures<>> material_textures) override;
