...
namespace RtEngine
{
    ...
    public:
        ...
        static std::vector<std::shared_ptr<MaterialInstance>> collectMaterialInstances(
    ...
    private:
        static void collectMeshAssetsRecursive(const std::shared_ptr<Node>& root_node,
        ...
        static void collectMaterialInstancesRecursive(const std::shared_ptr<Node>& root_node,
        ...
        static void collectCamerasRecursive(
            const std::shared_ptr<Node>& root_node, std::shared_ptr<std::vector<std::shared_ptr<Camera>>>& cameras)
        {
            for (auto child_node : root_node->children)
            {
