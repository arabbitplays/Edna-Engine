...
#define ALL_PROPERTY_FLAGS (SERIALIZABLE_PROPERTY_FLAG | PERSISTENT_PROPERTY_FLAG)
    ...
    public:
        ...
        virtual bool addInt(
            const std::string& name, int32_t* var, int32_t min, int32_t max, uint32_t flags = ALL_PROPERTY_FLAGS) = 0;
        virtual bool addInt(const std::string& name, int32_t* var, uint32_t flags = ALL_PROPERTY_FLAGS) = 0;

        virtual bool addUint(const std::string& name, uint32_t* var, uint32_t min, uint32_t max,
        ...
        virtual bool addFloat(
            const std::string& name, float* var, float min, float max, uint32_t flags = ALL_PROPERTY_FLAGS) = 0;
        ...
        virtual bool addVector(const std::string& name, glm::vec2* var, uint32_t flags = ALL_PROPERTY_FLAGS) = 0;
        virtual bool addVector(
            const std::string& name, glm::vec2* var, float min, float max, uint32_t flags = ALL_PROPERTY_FLAGS) = 0;
