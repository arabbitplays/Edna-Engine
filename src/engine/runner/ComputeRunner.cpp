...
namespace RtEngine
{
    ComputeRunner::ComputeRunner(
        std::shared_ptr<EngineContext> engine_context, std::shared_ptr<SceneManager> scene_manager)
        : engine_context(std::move(engine_context)), scene_manager(std::move(scene_manager)),
    ...
    void ComputeRunner::initProperties(
