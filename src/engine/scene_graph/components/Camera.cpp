...
namespace RtEngine
{
    ...
    void Camera::handleInputs()
    {
        ...
        if (firstMouse && glm::length(mouse_pos) > 0.001F)
    ...
    void Camera::updateTransform()
    {
        ...
        transform->decomposed_transform.translation +=
            glm::vec3(camera_rotation * glm::vec4(velocity * MOVE_SPEED, 0.F));
    ...
    {
        return transform->decomposed_transform.translation;
    }
